                ...
                <BaseTextBlock class="mb-40" :title="'Восстановление экосистем'">
                    <div>
                        <p class="mb-10">
                            ...
                            остатки нефтепродуктов, вытекших из&nbsp;поврежденного хранилища, и&nbsp;вывозили загрязненную
                            почву.
                        </p>
                        <p class="mb-10">
                        ...
                        <p class="mb-10">
                            ...
                            рыб,
                            какие
                            в&nbsp;них условия. Всё это поможет понять, как повысить выживаемость мальков ценных пород рыб
                            после
                            их
