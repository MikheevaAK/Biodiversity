        ...
        <MainSection>
            <section class="lake">
                ...
                <BaseTextBlock :title="'Что делает озеро рыбопродуктивным?'">
                    <p>
                        Озеро&nbsp;&mdash; это дом для множества живых организмов: от&nbsp;неразличимых невооружённым
                ...
                <BaseTextBlock class="mb-40" :title="'Работа над ошибками'">
                    <div>
                        <p class="mb-10">
                            ...
                            очистки
                            хозяйственно-бытовых сточных вод, сбрасываемых в&nbsp;окрестные водоёмы, и&nbsp;восстановить
                            популяции
                ...
                <BaseTextBlock :title="'В поиске альтернатив'">
                    <div>
                        ...
                        <p class="mb-10">
                            ...
                            другие
                            виды
                            фитопланктона&nbsp;&mdash; диатомовые и&nbsp;зелёные водоросли. Они лежат в&nbsp;основе
                            пищевой
                            цепочки
                        ...
                        <p>
                            ...
                            За&nbsp;несколько недель они облетели на&nbsp;специальном гидросамолёте местные озёра.
                        </p>
                    </div>
                ...
                <div class="in-search">
                    ...
                    <BaseTextBlock class="hidden-mobile">
                        <p>
                            ...
                            в&nbsp;планктоне
                            преобладали полезные диатомовые и&nbsp;зелёные водоросли, а&nbsp;доля цианобактерий
                            оказалась
                            заметно
                ...
                <BaseTextBlock class="visiable-mobile">
                    <div>
                        ...
                        <p class="mb-10">
                            ...
                            время
                            в&nbsp;планктоне преобладали полезные диатомовые и&nbsp;зелёные водоросли, а&nbsp;доля
            ...
            <section class="shares">
                ...
                <BaseTextBlock class="mb-40">
                    <p>
                        Поможет&nbsp;ли гуанотрофикация вернуть жизнь в&nbsp;арктические озёра&nbsp;&mdash; вопрос пока
                        открытый, и&nbsp;быстро ответить на&nbsp;него не&nbsp;получится. И&nbsp;всё&nbsp;же итоги
                        первого
                        года
                ...
                <BaseSidebar class="remove-padding">
                    <p>
                        &laquo;Норникель&raquo; вместе с&nbsp;учёными надеются разработать и&nbsp;опробовать экотехнологию
                        гуанотрофикации, которая позволит, при&nbsp;необходимости, повышать качество воды и&nbsp;продуктивность
                        арктических озёр.
                    </p>
                </BaseSidebar>
            </section>
