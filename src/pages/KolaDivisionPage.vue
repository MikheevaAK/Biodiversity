            ...
            <SectionWhite>
                    ...
                    <div class="scroll-wrap">
                        ...
                        <div class="scroll-card card-2 text-block__descr">
                            ...
                            <p>
                                ...
                                и&nbsp;фауны
                                водоплавающих птиц Мурманской области. Территория заповедника находится в&nbsp;юго-западном
                                направлении от&nbsp;промышленной площадки «Никель — Заполярный».
                            </p>
                        </div>
                ...
                <BaseTextBlock class="text mb-40" :title="'Зона воздействия предприятий Кольского дивизиона'">
                    <p class="mb-10">
                        ...
                        воздействия промплощадок Кольской ГМК и&nbsp;других объектов, оказывающих антропогеное влияние.
                    </p>
                    <p class="mb-10">
                        Трансформация природных сообществ напрямую зависит от&nbsp;интенсивности воздействия. По&nbsp;данным
                        исследований, наибольшие изменения обнаруживаются в&nbsp;пределах 1–3&nbsp;км от&nbsp;комбинатов.
                    </p>
                    <p class="mb-10">
                        Зона умеренного и&nbsp;незначительного воздействия протянулась на&nbsp;расстоянии 3–16&nbsp;км
                        от&nbsp;промплощадок
                        и&nbsp;в&nbsp;период до&nbsp;2020&nbsp;года захватывала часть территории заповедника «Пасвик»
                        и&nbsp;«Лапландского
                        заповедника». Всего за&nbsp;три&nbsp;года, в&nbsp;данным местах наблюдается активное восстановление,
                ...
                <BaseSidebar>
                    <p>
                        На&nbsp;состоянии природных сообществ дивизиона особенно сказывается изъятие территорий и&nbsp;крайне высокое
