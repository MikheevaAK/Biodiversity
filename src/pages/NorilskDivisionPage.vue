            ...
            <SectionWhite>
                ...
                <BaseTextBlock class="text mb-40" :title="'Зона воздействия предприятий Норильского&nbsp;дивизиона'"
                    ...
                    <p>
                        ...
                        а&nbsp;местами до&nbsp;2&nbsp;км от&nbsp;предприятий. С&nbsp;удалением от&nbsp;промышленной и&nbsp;жилой зон признаки воздействия сходят
                        на&nbsp;нет. Там, где
                        ...
                        <BaseTooltip :word="'фонового'">
                            ...
                            на&nbsp;фоновых территориях принимают за&nbsp;эталонное и&nbsp;используют эти данные для&nbsp;наблюдения за&nbsp;природой в&nbsp;зонах воздействия.
            ...
            <SectionOrange>
                ...
                <div class="flora-and-fauna">
                    ...
                    <BaseTextBlock :title="'Фауна'">
                        <p class="mb-10">
                            Территория дивизиона не&nbsp;отличается большим разнообразием млекопитающих, что типично для&nbsp;южных тундр. Птиц гораздо больше, но&nbsp;многие обитают здесь сезонно, из&nbsp;зимующих
                ...
                <BaseSidebar>
                    <p>
                        ...
                        всё это элементы системы, с&nbsp;помощью которой компания контролирует уровень промышленного воздействия и&nbsp;сохраняет обилие и&nbsp;разнообразие природы в&nbsp;дивизионе.
                    </p>
                </BaseSidebar>
            </SectionOrange>
        </MainSection>
